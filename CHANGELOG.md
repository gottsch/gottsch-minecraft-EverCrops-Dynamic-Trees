...
- Fixed a crash on startup that stopped the game from loading when the add-on was installed. The add-on wasn't able to hook into Dynamic Trees' trees, which brought everything down during loading. It now connects properly and starts up cleanly.
